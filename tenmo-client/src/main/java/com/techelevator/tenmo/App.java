...
public class App {
	...
	public RestTransferService restTransferService;
	...
	public App(ConsoleService console, AuthenticationService authenticationService) {
		...
		this.restTransferService = new RestTransferService();
	...
	private Transfer makeTransfer(int choice, String amount, String transferType, String transferStatus) {
		...
		int transferStatusId = transferStatusService.getTransferStatus(currentUser, transferStatus).getTransferStatusId();
		int accountFromId;
		int accountToId;
...
private void printTransferDetail(AuthenticatedUser authenticatedUser, Transfer transfer){
	...
	private void printTransferDetails(AuthenticatedUser currentUser, Transfer transferChoice) {
		...
		String transactionStatus = transferStatusService.getTransferStatusById(currentUser, transactionStatusId).getDescription();
